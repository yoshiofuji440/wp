...
*/
	...
	// モバイル用ボタンのサイズ
	/*
	$wp_customize->add_setting( 'mobile_button_size', array(
		'default'	=> 'small',
		'sanitize_callback' => 'thk_sanitize'
	));
	$wp_customize->add_control( 'mobile_button_size', array(
		'settings'	=> 'mobile_button_size',
		'label'		=> __( 'Button size', 'luxeritas' ),
		'section'	=> 'mobile_buttons_section',
		'type'		=> 'radio',
		'choices'	=> array(
			'small'		=> __( 'Small', 'luxeritas' ),
			'middle'	=> __( 'Middle', 'luxeritas' ),
			'big'		=> __( 'Big', 'luxeritas' ),
		),
		'priority'	=> 80
	));
	*/
