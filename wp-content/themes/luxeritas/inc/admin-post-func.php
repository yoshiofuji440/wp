...
add_action( 'enqueue_block_editor_assets', function() {
	...
	if( !isset( $luxe['block_debug'] ) && !isset( $luxe['block_editor_luxe_off'] ) ) {
		...
		/* 親テーマの URL を block.js に渡す */
		wp_localize_script( 'luxe-blocks', 'luxeThemeURL', get_template_directory_uri() );
		...
		wp_localize_script( 'luxe-blocks', 'luxeEmojiList', trim( $emoji_list ) );
	}
}, 11 );
