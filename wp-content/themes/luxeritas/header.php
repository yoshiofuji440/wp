...
<script>!function(e,o){var t=o.getElementById("head-parallax");if(null!==t){var l=o.getElementById("head-in"),n=o.getElementsByClassName("head-cover");t.style.overflow="hidden",e.addEventListener("scroll",function(){var e,t=o.documentElement.scrollTop||o.body.scrollTop;0<2*l.offsetHeight-t&&(e=t/<?php echo $head_parallax ?>+"px",l.style.backgroundPosition="0 "+e,n[0].style.transform="translate(0,"+e+")")})}}(window,document);;</script>
<?php
}
// Global Navi Under
